...
GAZETTEERS: list[dict[str, Any]] = [
    {
        "nome": "UF brasileira",
        "valores": _UFS,
        "categoria": "Localização Geográfica",
        "eixo": "dominio",
    ...
    },
    {
        "nome": "sexo/gênero",
        "valores": _SEXO,
        "categoria": "Perfil do Colaborador",
        "eixo": "dominio",
        "cobertura_minima": 0.9,
        "peso": 0.85,
        "max_distintos": 8,
    ...
    {
        "nome": "vínculo/contrato",
        "valores": _PORTE_CONTRATO,
    ...
    {
        "nome": "booleano textual",
        "valores": _BOOLEANOS,
        "categoria": "Status / Indicador / Flag",
        "eixo": "papel",
    ...
    {
        "nome": "status de atividade",
        "valores": _STATUS_ATIVIDADE,
        "categoria": "Status / Indicador / Flag",
        "eixo": "papel",
        "cobertura_minima": 0.8,
        "peso": 0.85,
    ...
    },
    {
        "nome": "mês",
        "valores": _MESES,
        "categoria": config.SEMANTICA_DATA_CALENDARIO,
        "eixo": "papel",
        "cobertura_minima": 0.9,
        "peso": 0.85,
        "max_distintos": 14,
